...
\documentclass[a4paper, 11.5pt]{Thesis}  % Use the "Thesis" style, based on the ECS Thesis style by Steve Gunn
...
\include{Chapters/Chapter3/Chapter3} % Dominio del problema
%Revisado
\include{Chapters/Chapter4/Chapter4} % Análisis %Incluir estadísticas

\include{Chapters/Chapter5/Chapter5} % Arquitectura física

\include{Chapters/Chapter6/Chapter6} % Arquitectura software

\include{Chapters/Chapter7/Chapter7} % Servicios del sistema operativo

\include{Chapters/Chapter8/Chapter8} % Aplicaciones

\include{Chapters/Chapter9/Chapter9} % Herramientas de terceros

\include{Chapters/Chapter10/Chapter10} % Metodología de desarrollo

\include{Chapters/Chapter11/Chapter11} % Evaluaciones y pruebas
