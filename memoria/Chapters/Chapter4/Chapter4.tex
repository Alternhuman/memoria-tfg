...
\hline
&\textbf{Virtualización de entornos de trabajo}\\%&Clúster con equipos embebidos multimedia&Clúster con sistemas embebidos\\
\hline
...
\begin{tabular}{|p{2.3cm}|p{12cm}|}
\hline
&\textbf{Clúster con equipos de escritorio}\\%&Clúster con equipos embebidos multimedia&Clúster con sistemas embebidos\\
\hline
Descripción&Crear un conjunto de nodos virtuales dentro de una máquina que simulen un sistema distribuido\\
\hline
...
%TODO\subsubsection{Objetos de datos}
