...
\hline
Prestaciones técnicas&Las prestaciones técnicas con las que se contaría, de llevarse a cabo este proyecto, son las de los equipos ya dispuestos para fines similares a este en el Centro\citationneeded[Preguntar a Andrés].\\
\hline
...
\hline
Consumo energético&\citationneeded[Preguntar a Andrés]\\
\hline
...
\hline
\end{tabular}
\caption{Evaluación de las características de la virtualización de entornos de trabajo}
\end{table}
...
\hline
\end{tabular}
\caption{Evaluación del uso de un clúster con equipos de escritorio}
\end{table}
...
\hline
\end{tabular}
\caption{Evaluación del uso de un clúster con computadores embebidos}
\end{table}
...
\hline
\end{tabular}
\caption{Evaluación del uso de un clúster con equipos embebidos multimedia}
\end{table}
...
\end{tabular}
\caption{Comparativa de las características relevantes de los diferentes modelos de Raspberry Pi.
...
El sistema se integrará en la organización objetivo utilizando diferentes recursos de la misma, como la red que interconecta todos los equipos o el mecanismmo de autenticación.
...
%TODO: IS 1 T2 pg 37
No se plantea la modificación de ninguno de los componentes anteriormente descritos.\citationneeded[TODO]%El coste total del proyecto no es elevado, por lo que no se solicitarán más presupuestos ni proveedores de los aquí listados.

\citationneeded[Objetivos funcionales]