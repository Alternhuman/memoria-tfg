...
Uno de los problemas típicos a la hora de crear un sistema distribuido es la localización de cada uno de los nodos que lo conforman. Soluciones como servicios de nombres (DNS) permiten crear estructuras jerárquicas donde cada nodo está identificado por un nombre previamente conocido. También existen protocolos inspirados en este como mDNS (\textit{Multicast Domain Name Service}) donde la necesidad de un servidor de nombres desaparece, y los nodos son capaces de encontrarse entre ellos mediante multicast\citationneeded. Otras alternativas como Bonjour, Avahi o AppleTalk (ya descontinuado) también han sido evaluadas. %TODO http://en.wikipedia.org/wiki/Multicast_DNS, http://tools.ietf.org/html/rfc6762, http://tools.ietf.org/html/bcp78, http://tools.ietf.org/html/rfc6760, http://en.wikipedia.org/wiki/AppleTalk, http://lathiat.net/files/avahi-lca2007.pdf, http://tools.ietf.org/html/rfc3927, http://tools.ietf.org/html/rfc3927, http://en.wikipedia.org/wiki/Network_Information_Service, http://mirror.linux.org.au/linux.conf.au/2007/video/monday/monday_1150_GNOME.ogg
...
El comando \texttt{reload} permite actualizar la lista de servicios que \textbf{Polo} ofrece sin tener que detener todo el proceso para ello. Dicho comportamiento se consigue de forma similar al comando \texttt{reload} de Apache, enviando la señal de UNIX \citationneeded \texttt{SIGUSR1} al proceso. 
...
La implementación del servicio está realizada íntegramente en Tornado\citationneeded, un servidor web ligero asíncrono implementado en Python.
