...
\begin{itemize}
  ...
  \item 2 GB de almacenamiento no expandibles.
  \item Alimentación por MicroUSB.
...
\begin{itemize}
  \item Generalemnte basados en la arquitectura ARM.
  ...
  \item Almacenamiento secundario basado en tarjetas MicroSD/SD, expandible a través de USB.
\end{itemize}
...
Se prevee que las necesidades que el sistema cubre no demandarán una mayor potencia de cálculo en el futuro.
...
LINPACK \cite{hackaday:benchmarkpi2,gist:linpackbenchmark,elinux:benchmark} & 40.64 & 40.64 & 92.88\\ \hline
