...
\begin{figure}[H]
  ...
  \caption[Beowulf]{Esquema de un clúster Beowulf. Este tipo de clústers permiten obtener una gran capacidad de cómputo paralelo con equipos de bajo coste, y generalmente se comportan como una única unidad.}
\label{fig:beowulf}
\end{figure}
