...
%TODO: En aquellos componentes basados en la colaboración entre partes se cumples las condiciones de todo algoritmo distribuido. 
...
Sin embargo, todas las herramientas han sido diseñadas con el objetivo de ser compatibles con cualquier otro entorno. Han sido integradas en diferentes equipos de escritorio con el sistema GNU/Linux. %TODO y entornos virtualizados.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{Chapter2/Figures/map-reduce}
...
Junto a paradigmas populares como el orientado a objetos y procedural es necesario mencionar una serie de conceptos menos conocidos:
