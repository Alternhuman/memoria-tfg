...
Gestión de varias partes del sistema (sistema de ficheros centralizado, gestión de usuarios...) de forma mas sencilla.
...
Requiere una etapa de formación en materia de virtualización
...
\paragraph{Ventajas intrínsecas de la solución}
La potencia del sistema es mucho mayor que la de cualquier otra solucion.
...
\paragraph{Inconvenientes intrínsecos del sistema}
No se exploran las características únicas de otros sistemas menos ``convencionales'', tales como la utilización de sistemas embebidos.
Consumo mayor.
...
\paragraph{Necesidades de mantenimiento}
Las necesarias en cualquier sistema GNU/Linux y las específicas del montaje dado (en materia de refrigeración, gestión de cableado, etc)
\paragraph{Consumo energético del sistema}
...
Evaluación de rendimiento con LINPACK [5][6][7] & 40.64 & 40.64 & 92.88\\ \hline
...
Consumo medio [8] & 700 mA, 5 V (3.5 W) & 600 mA, 5 V (3 W) & 800 mA, 5 V (4 W)\\ \hline
...
\item Lista completa en [1]
\end{itemize} & Los mismos que para el modelo B & Hasta la fecha, únicamente:
\begin{itemize}

\item Ubuntu Snappy Core
\item Raspbian
\item OpenELEC
\item RISC OS
\item Según la web de ArchLinux, también soporta este sistema operativo [2]
\end{itemize}\\ \hline % 
...
% [2] ArchLinux en Raspberry Pi Rev 2 http://archlinuxarm.org/platforms/armv7/broadcom/raspberry-pi-2
...
% [5] Benchmarking The Raspberry Pi 2 (consultado el 5/03/2015)   http://hackaday.com/2015/02/05/benchmarking-the-raspberry-pi-2/
% [6] Raspberry Pi 2 Linpack Benchmark https://gist.github.com/jitomesky/fcfc9a3653aaf550d753
% [7] RPi Performance-Embedded Linux Wiki http://elinux.org/RPi_Performance
% [8]  RasPiTV - 
...
Gentoo & Diseñado para permitir la personalización del sistema al máximo nivel posible & Enfocado en la personalizacion, siendo el sistema compilado en la maquina sobre la que se va a utilizar en vez de ser descargado como archivo binario & Permite ser customizado de forma sencilla & Poco soportado en Raspberry Pi & \\ \hline

Windows 10 & Diseñado para el paradigma IoT & Sencillo de utilizar Soporte de .NET & Poco probado. Esta diseñado para un proposito especifico. No compatible con software para Linux de forma nativa & & \\ \hline
